    ...
    <div class="container">
        <div class="d-flex justify-content-between align-items-center">
            <div class="d-flex justify-content-start align-items-center logo">
                <a href="index.php">
                    <img src="../storage/logo.png" alt="Logo" class="img-fluid" style="height: 120px; width: auto">
                </a>
...
<header class="hero">
  <div class="container">
    ...
    <p class="small-muted mb-0">Wpisy, zdjęcia i wskazówki dla wędrowców.</p>
  </div>
</header>
...
<div class="container">
    ...
    <div class="d-flex justify-content-end">
        ...
        <a href="index.php?sort=date" class="me-2"><img src="../storage/1.png" width="10%"></a>
        <a href="index.php"><img src="../storage/2.png" width="10%"></a>
    </div>
    <main class="py-4">
        <div class="row">
